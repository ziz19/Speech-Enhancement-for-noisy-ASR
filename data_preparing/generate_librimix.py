"""
This file creates the LibriMix 1 source 8k dataset, configured from original LibriMix script
"""
import os
import argparse
...
parser.add_argument('--wham_dir', type=str, default='D:\LibriMix\data\wham_noise',
                    help='Path to wham root directory')
parser.add_argument('--metadata_dir', type=str, default='D:\LibriMix\metadata\Libri2Mix',
                    help='Path to the LibriMix metadata directory')
parser.add_argument('--librimix_outdir', type=str, default='D:\LibriMix\data',
...
parser.add_argument('--modes', nargs='+', default=['min'],
                    help='--modes min max will create 2 directories in '
                         'each freq directory')
parser.add_argument('--types', nargs='+', default=['mix_single'],
