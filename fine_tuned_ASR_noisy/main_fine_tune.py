...
hparams = {"seq_cost": lambda x, y, z: speechbrain.nnet.losses.nll_loss(x, y, z, label_smoothing=0.1),
           ...
           "checkpointer": speechbrain.utils.checkpoints.Checkpointer(checkpoints_dir='./fine_tuned_ASR_noisy',
           ...
           "train_logger": speechbrain.utils.train_logger.FileTrainLogger(save_file="./fine_tuned_ASR_noisy/train_log.txt"),
           "wer_file": "./fine_tuned_ASR_noisy/test_wer.txt"
           }


sb.create_experiment_directory(
    experiment_directory='./fine_tuned_ASR_noisy'
)
